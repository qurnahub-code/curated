...
const appCss = "/assets/styles-BMcqZdOq.css";
...
const $$splitComponentImporter$1 = () => import("./index-DrTf_sxd.mjs");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Buy and sell premium digital products, templates, and creative assets."
    }, {
      property: "og:title",
      content: "Curated — Digital Marketplace"
    }, {
...
const $$splitComponentImporter = () => import("../_productId-BRAXdPsB.mjs");
const Route = createFileRoute("/product/$productId")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "View product details on Curated marketplace."
    }]
  }),
